...
INSTALL_GIT() {
  ...
  then
    ...
    then
      echo "\033[1;34;40m pegaz :: install GIT \033[0m"
    ...
    then
      ...
      echo "\033[1;34;40m pegaz :: install git first: https://github.com/git-guides/install-git \033[0m"
      return 3
    fi
  else
    echo "\033[1;34;40m pegaz :: skip GIT \033[0m"
    return 0
  fi
}
INSTALL_DOCKER() {
  ...
  then
    echo "\033[1;34;40m pegaz :: install DOCKER \033[0m"
    ...
    echo "\033[1;34;40m pegaz :: skip DOCKER \033[0m"
  fi
}
CREATE_NETWORK() {
  if ! echo $(docker network ls) | grep -q pegaz
  then
    echo "\033[1;34;40m pegaz :: create NETWORK \033[0m"
...
CLONE_PROJECT() {
  ...
  then
    echo "\033[1;34;40m pegaz :: clone PROJECT \033[0m"
