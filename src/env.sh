...
export URL_DOCKERWEB_STORE="https://raw.githubusercontent.com/docker-web/docker-web/main/store/archives"
export PATH_DOCKERWEB=/var/docker-web
export PATH_DOCKERWEB_APPS=$PATH_DOCKERWEB/store/apps
