export DOCKERWEB_VERSION="2024.5.30"
...
export COMMANDS_APP="drop up start update reset logs backup restore storjbackup storjrestore state post_install pre_install add_to_hosts exec"
