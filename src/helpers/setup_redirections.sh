SETUP_REDIRECTIONS() {
  ...
  then
    ...
    [[ ! -f "$PATH_DOCKERWEB_APPS/$1/$FILENAME_NGINX" ]] && touch "$PATH_DOCKERWEB_APPS/$1/$FILENAME_NGINX" $PATH_FILE_REDIRECTION
    REMOVE_LINE $AUTO_GENERATED_STAMP "$PATH_DOCKERWEB_APPS/$1/$FILENAME_NGINX"
