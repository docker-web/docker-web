...
docker cp $PATH_DOCKERWEB_SERVICES/$1/css/deluge.css deluge:$DARK_PATH/css
docker cp $PATH_DOCKERWEB_SERVICES/$1/css/deluge-dark.css deluge:$DARK_PATH/css
docker cp $PATH_DOCKERWEB_SERVICES/$1/images deluge:$DARK_PATH/images
...
docker cp $PATH_DOCKERWEB_SERVICES/$1/jellyfin_scan.sh deluge:/home
