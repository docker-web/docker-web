...
export PORT_DB="7705"
export APPS_PRE_INSTALLED="calendar contacts mail notes music spreed extract metadata richdocuments richdocumentscode camerarawpreviews sharerenamer"
...
export POST_INSTALL_TEST_CMD="docker exec -u www-data nextcloud php occ"