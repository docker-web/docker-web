...
export REDIRECTIONS="notes.$MAIN_DOMAIN->/apps/notes mail.$MAIN_DOMAIN->/apps/mail calendar.$MAIN_DOMAIN->/apps/calendar contact.$MAIN_DOMAIN->/apps/contacts map.$MAIN_DOMAIN->/apps/maps"
