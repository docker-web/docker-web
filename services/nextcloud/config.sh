...
export PORT_DB="7705"
export APPS_PRE_INSTALLED="calendar contacts mail notes music spreed extract metadata richdocuments richdocumentscode maps camerarawpreviews sharerenamer apporder"
...
export REDIRECTIONS="notes->/apps/notes mail->/apps/mail cal->/apps/calendar contact->/apps/contacts map->/apps/maps /apps/files/->/apps/files?dir=/local"
