...
export COMMANDS_CORE="config help port ports uninstall upgrade version ps create storj prune"
export COMMANDS_SERVICE="drop up start update reset logs backup restore storjbackup storjrestore state init post_install pre_install add_to_hosts exec"
