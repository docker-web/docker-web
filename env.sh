...
export COMMANDS_SERVICE="destroy dune prune up update reset"
export COMMANDS_COMPOSE="build bundle config create down events exec help images kill logs pause port ps pull push restart rm run scale start stop top unpause up version"
